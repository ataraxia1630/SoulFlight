...
const { CartDTO, CartItemDTO } = require("../dtos/cart.dto");
...
const CartController = {
  ...
  addToCart: catchAsync(async (req, res) => {
    ...
    res.status(201).json(ApiResponse.success(CartItemDTO.itemFromModel(item)));
  }),
  ...
  updateCartItem: catchAsync(async (req, res) => {
    ...
    res.status(200).json(ApiResponse.success(CartItemDTO.itemFromModel(item)));
  }),
