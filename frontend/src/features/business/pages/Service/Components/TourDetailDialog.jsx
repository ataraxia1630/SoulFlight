          ...
          <Box sx={{ p: 3 }}>
            ...
            {data.tourguide && (
              <Box sx={{ mb: 3 }}>
                ...
                >
                  <Person color="primary" fontSize="small" /> Hướng dẫn viên
                </Typography>
                <Paper
                  variant="outlined"
                  sx={{
                ...
                >
                  <Avatar
                    src={data.tourguide.image_url}
                    alt={data.tourguide.name}
                    sx={{ width: 50, height: 50, border: "1px solid #ddd" }}
                  >
                    {data.tourguide.name?.charAt(0)}
                  </Avatar>
                  <Box>
                    ...
                    >
                      <Phone fontSize="inherit" /> {data.tourguide.phone}
                    </Typography>
                  </Box>
                </Paper>
              </Box>
