...
export default function DetailDialog({ open, onClose, onSubmit, voucher }) {
    ...
    if (open) {
      const fetchServices = async () => {
        ...
        try {
          ...
          console.log("Fetched services for voucher dialog:", res);
  ...
  useEffect(() => {
    if (voucher) {
      reset({
        serviceId: voucher.serviceId || (voucher.service ? voucher.service.id : ""),
        title: voucher.title || "",
        code: voucher.code || "",
        ...
        <Controller
          ...
          render={({ field }) => (
            <TextField
              ...
              disabled={loadingServices || !!voucher}
            >
              {loadingServices ? (
                <MenuItem disabled>
